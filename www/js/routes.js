  ...
  routes: [
        ...
        pageInit: function (event, page) {
          ...
          $("#logoutButton").on("click", function () {
            ...
            window.location.href =
              "https://ifpi-picos.github.io/projeto-integrador-redatorpro/login"; // Caminho relativo para o arquivo fora de www
          });
                ...
                data.forEach((corretor) => {
                  var corretorHTML = `
                      <a data-id="${corretor.id}" href="#" class="item">
                          <div class="person-card" data-name="${
                            corretor.name
                          }" data-specialty="${corretor.escolaridade || ""}">
                              <div class="person-info">
                                  ...
                                  <div class="person-details">
                                      ...
                                      <p class="person-specialty">${
                                        corretor.escolaridade || ""
                                      }</p>
                                  </div>
                              </div>
                              <div class="person-rating">
                                  ...
                                  <span class="rating-score">${
                                    typeof corretor.rating === "number"
                                      ? corretor.rating.toFixed(1)
                                      : "0.0"
                                  }</span>
                              </div>
                          </div>
    ...
    },
    {
      ...
      on: {
        pageInit: function () {
          var start = function () {
            if (typeof window.initProgresso === "function") {
              window.initProgresso();
            }
          };
          ...
          if (typeof window.initProgresso === "function") {
            ...
            $.getScript("js/progresso.js", start);
          }
        },
        pageBeforeRemove: function () {
          if (window.__progressCharts) {
            Object.keys(window.__progressCharts).forEach(function (key) {
              var chart = window.__progressCharts[key];
              if (chart && typeof chart.destroy === "function") {
                chart.destroy();
              }
            });
            window.__progressCharts = {};
          }
        },
      },
    },
